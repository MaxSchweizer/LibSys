...
class BooksControllerTest < ActionController::TestCase
  ...
  test "create new book with bad isbn data" do
    ...
    lib_user = LibraryMember.create!(:name => "n2", :email => "n2@g.com", :password => "123")
    session[:user_id] = user.id
    post :create, {book: {isbn: "0101", title: "This is the changed title", authors: "200", description: "200"}, status: "false", library_member: lib_user.id}
    assert_response :success
    assert_equal "Yellow", Book.find_by_isbn("0101").title
  end
